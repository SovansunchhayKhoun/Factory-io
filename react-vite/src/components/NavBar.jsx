    ...
    px-2 py-2">
        <section className="flex justify-between items-center w-full">
          ...
          <div className="md:flex md:flex-row md:items-center md:gap-x-2 flex gap-x-1 items-center">
            ...
            <AdminPopUp modalOpen={modalOpen} setModalOpen={setModalOpen} content={<CustomerService setModalOpen={setModalOpen}/>} id={100}/>
          </div>
          ...
          <div className="md:hidden flex gap-x-1 items-center">
            ...
            <div>
              {token ?
                <ProfileDropdown user={user} arrowIcon={false}/>
                :
                <NoAccount />
              }
            </div>
