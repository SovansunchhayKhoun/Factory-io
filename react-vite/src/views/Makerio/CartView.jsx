...
export const CartView = () => {
  ...
  const {userAddress, getUserAddress, addressLoading, setAddressLoading} = useAddressContext();
  const {cartItem, getCartItem} = useContext(CartContext);
  const {handleAddressChange, setTempAddress, tempAddress} = useContext(GoogleMapsContext);
