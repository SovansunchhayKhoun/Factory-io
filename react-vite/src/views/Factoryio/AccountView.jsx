        ...
        <section className="min-w-[900px] flex flex-col gap-6">
          <section className="shadow-xl">
            ...
            <section className="flex justify-center">
              <img className="aspect-[188/111] w-full max-h-[360px] object-cover" src="/assets/images/board.jpg" alt=""/>
            </section>
          ...
          <section className="flex">
            ...
            <section className="self-start grid grid-rows-3 justify-center items-center border border-redBase">
              <div className="transition duration-200 cursor-pointer hover:bg-gray-200 px-10 py-2 flex items-center gap-2">
              ...
              <button onClick={onLogout} className="transition duration-200 cursor-pointer hover:bg-gray-200 px-10 py-2 flex items-center gap-2">
