...
export const LandingPage = () => {
  return (
    <main className="">
      <div className="flex justify-center mb-12 columns-2">
        <div className="mr-12 ">
      ...
      <div className="px-40 flex justify-center h-[300px]">
        <div className="flex justify-start w-[450px] h-[250px] mr-4">
      ...
      <div className="px-38 mb-12 flex flex-col items-center p-2 font-medium">
      ...
      <div className="px-48 flex flex-col items-center gap-y-3 mt-5">
        ...
        <div>
            <span className="flex flex-col justify-center-center gap-y-6 p-2 font-normal text-center mb-12">
