  ...
  return (
    <div className="px-12 py-3 flex items-center justify-between border-2 border-tealActive shadow-2xl">
      <div className="flex items-center gap-x-6">
        ...
        <div>
          <div className="mb-1 font-bold text-blueBase">${props.price}</div>
          <div className="mb-1 text-tealHover font-bold">{props.name}</div>
          <div className="mb-1 text-blackFactory">Item Type: Arduino</div>
          <div className="mb-1 flex items-center gap-x-2">
            <button onClick={() => {
              decreaseItemQty(props.id)
            }}>-
            </button>
