            ...
            {filteredItem?.slice(0, 5).map((item, key) => {
              return (
                <Link to={`${item.id}`} onClick={e => {
                  ...
                  <img className="w-[50px]" src={`${imgUrl}/${item.image}`} alt={item.name}/>
                </Link>
              )
            })}
          </div>
            ...
            <Link to="/makerio/shop">
              <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                <path
                  ...
                  stroke={`${location.pathname === '/makerio/shop' ? '#8A0000' : '#00727A'}`} strokeWidth="2"
                ...
                <Link to={"/makerio/cart"}>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    <path
                      ...
                      fill={`${location.pathname === '/makerio/cart' ? '#8A0000' : '#00727A'}`}/>
                  </svg>
                </Link>
                <span
                ...
                <><Link className="relative" to={
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    <path
                      ...
                      fill={`${location.pathname === '/makerio/order' ? '#8A0000' : '#00727A'}`}/>
                    <path
