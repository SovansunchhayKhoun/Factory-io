          ...
          <section className="flex flex-col">
              ...
              <section className='justify-center flex flex-col w-full gap-y-3'>
                ...
                <section className='flex flex-col gap-3'>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <AdminPopUp
                      content={<FundProjectContent project={project} projectPrototypes={project?.projectPrototypes}
            ...
            <section className="flex gap-4">
              ...
              <section className="pt-4 w-full">
                ...
                {tab === 'project' &&
                  <PVProjectTab setSection={setSection} setCurrentItem={setCurrentItem} user={user} initChat={initChat}
                                project={project} projectPrototypes={project?.projectPrototypes}/>}
              </section>
            </section>
          </section>
        </section>
